        ...
        <div style="width: 600px;height: 500px; background-color: white;margin: auto;margin-top: 100px;">
            ...
            <div style="width: 600px;height: 300px;">
                <el-form ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" label-width="120px"
                    ...
                    <el-form-item label="verifyCode" prop="verify">
                        <el-input style="width: 200px;" v-model="ruleForm.verify" type="text" autocomplete="off" />
                        <el-image style="margin-left: 10px;width: 100px; height: 50px" :src="url" @click="getVerifyCodeUrl">
                            <template #error>
                                <div class="image-slot" style="background-color: #f6f6f6;line-height: 20px;"
                                    @click="getVerifyCodeUrl">
                                    <span>输入账号点击生成验证码</span>
                                </div>
                            </template>
                        </el-image>
                    </el-form-item>
...
const rules = reactive<FormRules>({
    ...
    verify: [{ validator: validatePass, trigger: 'blur' }],
...
const getVerifyCodeUrl = () => {
    ...
    axios.get('/user/verification/' + ruleForm.account).then(response => {
        if (response.data.code == 200) {
            ...
            url.value = 'data:image/png;base64,' + response.data.data
        }
